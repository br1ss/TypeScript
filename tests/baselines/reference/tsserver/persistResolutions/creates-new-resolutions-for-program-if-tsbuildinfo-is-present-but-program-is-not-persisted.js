...
ConfigFilePresence:: Current Watches: :: File: /user/username/projects/myproject/src/tsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles: /user/username/projects/myproject/src/main.ts Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /user/username/projects/myproject/src/jsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles: /user/username/projects/myproject/src/main.ts Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /user/username/projects/myproject/tsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles: /user/username/projects/myproject/src/main.ts Status: File added to open files impacted by this config file
For info: /user/username/projects/myproject/src/main.ts :: Config file name: /user/username/projects/myproject/tsconfig.json
Opened configuration file /user/username/projects/myproject/tsconfig.json
...
DirectoryWatcher:: Added:: WatchInfo: /user/username/projects/myproject/src 1 undefined Project: /user/username/projects/myproject/tsconfig.json WatchType: Wild card directory
Elapsed:: *ms DirectoryWatcher:: Added:: WatchInfo: /user/username/projects/myproject/src 1 undefined Project: /user/username/projects/myproject/tsconfig.json WatchType: Wild card directory
Plugins were requested but not running in environment that supports 'require'. Nothing will be loaded
FileWatcher:: Added:: WatchInfo: /user/username/projects/myproject/src/anotherFileReusingResolution.ts 500 undefined Project:  WatchType: Closed Script info
FileWatcher:: Added:: WatchInfo: /user/username/projects/myproject/src/filePresent.ts 500 undefined Project:  WatchType: Closed Script info
FileWatcher:: Added:: WatchInfo: /user/username/projects/myproject/src/fileWithRef.ts 500 undefined Project:  WatchType: Closed Script info
FileWatcher:: Added:: WatchInfo: /user/username/projects/myproject/src/globalAnotherFileWithSameReferenes.ts 500 undefined Project:  WatchType: Closed Script info
FileWatcher:: Added:: WatchInfo: /user/username/projects/myproject/src/globalFilePresent.ts 500 undefined Project:  WatchType: Closed Script info
FileWatcher:: Added:: WatchInfo: /user/username/projects/myproject/src/globalMain.ts 500 undefined Project:  WatchType: Closed Script info
FileWatcher:: Added:: WatchInfo: /user/username/projects/myproject/src/types.ts 500 undefined Project:  WatchType: Closed Script info
...
ConfigFilePresence:: Current Watches: :: File: /user/username/projects/tsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles:  Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /user/username/projects/jsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles:  Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /user/username/tsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles:  Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /user/username/jsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles:  Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /user/tsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles:  Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /user/jsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles:  Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /tsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles:  Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /jsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles:  Status: File added to open files impacted by this config file
...
FileWatcher:: Close:: WatchInfo: /user/username/projects/myproject/src/globalMain.ts 500 undefined Project:  WatchType: Closed Script info
Search path: /user/username/projects/myproject/src
ConfigFilePresence:: Current Watches: :: File: /user/username/projects/myproject/src/tsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles: /user/username/projects/myproject/src/main.ts,/user/username/projects/myproject/src/globalMain.ts Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: :: File: /user/username/projects/myproject/src/jsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles: /user/username/projects/myproject/src/main.ts,/user/username/projects/myproject/src/globalMain.ts Status: File added to open files impacted by this config file
ConfigFilePresence:: Current Watches: Config file:: File: /user/username/projects/myproject/tsconfig.json Currently impacted open files: RootsOfInferredProjects:  OtherOpenFiles: /user/username/projects/myproject/src/main.ts,/user/username/projects/myproject/src/globalMain.ts Status: File added to open files impacted by this config file
...
DirectoryWatcher:: Triggered with /user/username/projects/myproject/src/globalNewFile.ts :: WatchInfo: /user/username/projects/myproject/src 1 undefined Project: /user/username/projects/myproject/tsconfig.json WatchType: Wild card directory
...
DirectoryWatcher:: Triggered with /user/username/projects/myproject/src/globalFileNotFound.ts :: WatchInfo: /user/username/projects/myproject/src 1 undefined Project: /user/username/projects/myproject/tsconfig.json WatchType: Wild card directory
...
DirectoryWatcher:: Triggered with /user/username/projects/myproject/src/newFile.ts :: WatchInfo: /user/username/projects/myproject/src 1 undefined Project: /user/username/projects/myproject/tsconfig.json WatchType: Wild card directory
Scheduled: /user/username/projects/myproject/tsconfig.json
Scheduled: *ensureProjectForOpenFiles*
...
DirectoryWatcher:: Triggered with /user/username/projects/myproject/src/fileNotFound.ts :: WatchInfo: /user/username/projects/myproject/src 1 undefined Project: /user/username/projects/myproject/tsconfig.json WatchType: Wild card directory
Scheduled: /user/username/projects/myproject/tsconfig.json
Scheduled: *ensureProjectForOpenFiles*
